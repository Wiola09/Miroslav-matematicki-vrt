...
function predictImage() {
    ...
    let gsize = new cv.Size(image.cols, image.rows);
    cv.warpAffine(image, image, M, gsize, cv.INTER_LINEAR, cv.BORDER_CONSTANT, new cv.Scalar());
